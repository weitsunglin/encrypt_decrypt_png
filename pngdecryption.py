...
if __name__ == "__main__":
    encrypted_img_path = os.path.join(os.getcwd(), 'test_encrtpy.png')  # 假设加密的文件名为test_encrtpy.png
    decrypted_img_path = os.path.join(os.getcwd(), 'test_decrtpy.png')  # 解密后要保存的新文件名
